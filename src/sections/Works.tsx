...
import { ArrowUpRight, ShoppingCart, Play, Pause } from 'lucide-react';
...
export function Works() {
  ...
  const handlePurchaseClick = (e: React.MouseEvent, purchaseLink: string) => {
    e.stopPropagation();
            ...
            >
              ...
              <div className="relative aspect-[3/4] overflow-hidden bg-dark-gray">
                ...
                <button
                  ...
                  className="absolute top-6 left-6 w-14 h-14 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-highlight hover:scale-115 transition-all duration-300 z-20"
                >
                  {playingIndex === index ? (
                ...
                <div className="absolute top-6 right-20">
                  <div className="px-4 py-2 bg-highlight text-white font-medium text-body">
                    ${project.price}
                  </div>
                </div>
                ...
                <button
                  ...
                  className="absolute top-6 right-6 w-14 h-14 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-highlight hover:scale-115 transition-all duration-300 z-20"
                >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                  ...
                  <h3 className="text-h4 lg:text-h3 text-white font-medium group-hover:-translate-y-1 transition-transform duration-300 mb-3">
                    {project.title}
                  </h3>
