...
const TourSchedule = ({ onSetupClick }: { onSetupClick?: () => void }) => {
      ...
      <div ref={contentRef} className="relative z-20 max-w-7xl mx-auto px-6 md:px-12">
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div className="flex-grow">
                      <p className="font-mono-custom text-xs text-[#1F1F1F]/60 uppercase tracking-wider mb-1">
                        {tour.date}
                      </p>
                      <h3 className="font-display text-lg text-[#1F1F1F] mb-1">
                        {tour.city}
                      </h3>
        ...
        <div className="mt-20 text-center">
          ...
          <button
            ...
            className="px-8 py-4 bg-[#1F1F1F] text-white font-display text-sm uppercase tracking-wider rounded-full hover:bg-[#1F1F1F]/80 transition-colors"
          >
